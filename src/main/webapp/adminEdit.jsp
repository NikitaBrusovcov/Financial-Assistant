...
<div>
    ...
    <form method="post" action="${pageContext.request.contextPath}/editProfileButton"
        ...
        <section>
            ...
            <div>
                <label>
                    <input type="password" placeholder="<fmt:message key="label.oldPassword"/>" name="oldPassword"
                           minlength="6">
                </label>
                <label>
                    <input type="password" placeholder="<fmt:message key="label.newPassword"/>" name="password"
                           minlength="6">
                </label>
                <label>
