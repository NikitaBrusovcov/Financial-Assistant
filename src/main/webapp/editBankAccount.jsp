        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10">
                <div class="contact-form wow fadeInUp" data-wow-delay="0.7s">
                    <h2><fmt:message key="label.edit"/> <fmt:message key="label.bankAccount"/></h2>
                </div>
                <form id="contact-form" method="post" action="${pageContext.request.contextPath}/editBankAccount">
                    <input type="hidden" name="id" value="${bankAccount.id}">
                    <input type="text" class="form-control" placeholder="${bankAccount.title}" name="title">
                    <button class="form-control" name="actionBankAccount" value="edit"><fmt:message
