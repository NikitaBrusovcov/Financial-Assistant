        ...
        <nav id="nav">
            <ul>
                ...
                <c:if test="${not empty sessionScope.user}">
                    <li><a href="${pageContext.request.contextPath}/account"><fmt:message key="label.bankAccount"/></a></li>
                    <li><a href="${pageContext.request.contextPath}/rainyDayAccount"><fmt:message key="label.rainyDayAccount"/></a></li>
                    <li><a href="${pageContext.request.contextPath}/profile">${sessionScope.user.name}</a></li>
                    <li><a href="${pageContext.request.contextPath}/support"><fmt:message key="label.support"/></a></li>
